      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div ref={textRef} className="flex-1 text-center lg:text-left">
          ...
          <div className="hero-text flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            ...
            <a href="#projects" onClick={(e) => handleViewWork(e, 'projects')} className="cursor-pointer px-8 py-3 rounded-full font-semibold border-2 border-slate-300 dark:border-slate-700 hover:border-blue-500 transition-colors">
              View Work
            </a>
          </div>
          ...
          <div className="hero-text flex items-center gap-6 mt-12 justify-center lg:justify-start">
            <SocialLink href="https://github.com/gulamrasul23" icon={<FiGithub size={24} />} />
            <SocialLink href="https://www.linkedin.com/in/gulam-rasul" icon={<FiLinkedin size={24} />} />
            <SocialLink icon={<FiTwitter size={24} />} />
            <SocialLink icon={<FiFacebook size={24} />} />
          </div>
        </div>
