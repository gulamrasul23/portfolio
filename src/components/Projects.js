...
// In a real app we would use next/image, but handling placeholder paths with it needs config, 
// so we'll use a normal img or a stylized div to represent the project image

export default function Projects() {
  return (
    <section id="projects" className="py-12 lg:py-16 xl:py-20 relative overflow-hidden">
          ...
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className="relative h-48 w-full overflow-hidden bg-slate-200 dark:bg-slate-800">
                {/* Fallback pattern for placeholder image */}
