...
// Optional experience data. If empty, we show a fallback.
const expData = []; // Let's keep it empty as a placeholder for "Open to opportunities"

export default function Experience() {
  return (
    <section id="experience" className="py-12 lg:py-16 xl:py-20 relative">
